...
public class DogKennel {
    public static void main(String[] args) {
        ...
        // sæt en ejer
        myDog.setOwner(new Owner("Simon"));
        // TODO: tilføj to hvalpe når hundeklassen er klar til hvalpe
        myDog.setOffSpring(new Dog("Karla", true));
        myDog.setOffSpring(new Dog("Lily", true));

        // print alle hvalpe
        ArrayList<Dog> myOffSpring = Dog.getOffSpring();
            for(Dog a: myOffSpring) {
